...
`Language: EN` `Academic presentations` `Source file: meta_prompt_for_presentations_course_nzbt_2026_requirements.md`
...
- Slide content
- Bioprocess and media design sections

## Expected Results

- Better alignment with 2026 requirements
- Stronger academic sequencing
- Cleaner slide-ready wording

## Inputs to Prepare

- Coursework materials
- NUFT/NGBT requirements
- Topic and product details
...
Original local source: [meta_prompt_for_presentations_course_nzbt_2026_requirements.md](../../source/meta_prompt_for_presentations_course_nzbt_2026_requirements.md)
